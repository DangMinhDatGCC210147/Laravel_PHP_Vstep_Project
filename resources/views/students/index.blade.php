                ...
                <div class="form-items">
                    <div class="form-icon">
                        <div class="icon-holder" style="color: white;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        @csrf
                        <input class="form-control" type="email" name="email" placeholder="E-mail FPT Address" required>
